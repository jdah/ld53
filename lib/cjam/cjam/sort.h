...
// adapted from stackoverflow.com/questions/4300896
struct _sort_data {
    void *arg;
    int (*cmp)(const void *a, const void *b, void *arg);
};

ALWAYS_INLINE int _sort_r_arg_swap(void *s, const void *aa, const void *bb) {
    struct _sort_data *ss = s;
    return (ss->cmp)(aa, bb, ss->arg);
}

typedef int (*f_sort_cmp)(const void *a, const void *b, void *arg);
...
#else
    #error cannnot detect platform for sort!
#endif
}
